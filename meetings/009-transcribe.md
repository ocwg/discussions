...
I don't have any special expertise in licensing. And I don't know if anyone that's on the call now has a good sense of that, or maybe Aaron, this is something that we could learn from the GLTF community. Like is there a pattern that we should follow that GLTF has already gone through here?
